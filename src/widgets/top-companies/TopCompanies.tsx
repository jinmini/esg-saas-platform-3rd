...
import { useHighRiskCompanies } from '@/entities/company';
import { formatRiskScore, getRiskLevel, RiskLevel } from '@/entities/risk';
import { cn } from '@/shared/lib';
import { Badge } from '@/shared/ui/Badge';

// useHighRiskCompanies 훅의 반환 데이터 타입 정의
interface CompanyRiskInfo {
  company: {
    id: string;
    name: string;
    industry: string;
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {companyRisk.topIssues.length > 0 && (
                        <div className="flex flex-wrap gap-1 mt-2">
                          {companyRisk.topIssues.slice(0, 2).map((issue: string, idx: number) => (
                    ...
                    <div className="text-right">
                      ...
                      <RiskBadge level={riskLevel as RiskLevel} size="sm" />
                    </div>
                  </div>
                );
              })
