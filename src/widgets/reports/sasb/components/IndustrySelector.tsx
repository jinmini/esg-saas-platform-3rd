...
export function IndustrySelector({
  ...
  const currentIndustry = selectedIndustry ? industries[selectedIndustry] : null;
    ...
    <div className="space-y-6">
      <div>
        ...
        <div className="space-y-2">
          {Object.values(industries).map((industry: any) => (
            <Card 
              key={industry.id}
              ...
              onClick={() => {
                ...
                onSectorSelect(industry.sectors[0]?.id || null);
              }}
            >
      ...
      {currentIndustry && (
        <div>
          ...
          <div className="space-y-2">
            {currentIndustry.sectors.map((sector: any) => (
              <Card 
                key={sector.id}
                className={`cursor-pointer transition-all duration-200 ${
